...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="bi bi-pencil me-2"></i>Edit Category</h1>
    <a href="{{ route('admin.categories.show', $category) }}" class="d-none d-sm-inline-block btn btn-secondary shadow-sm">
    ...
    <div class="card-body">
        <form action="{{ route('admin.categories.update', $category) }}" method="POST">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="{{ route('admin.categories.show', $category) }}" class="btn btn-secondary me-md-2">Cancel</a>
