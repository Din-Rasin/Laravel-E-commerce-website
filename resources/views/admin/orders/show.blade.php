...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="bi bi-bag me-2"></i>Order #{{ $order->id }}</h1>
    <a href="{{ route('admin.orders.index') }}" class="d-none d-sm-inline-block btn btn-secondary shadow-sm">
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <div class="card admin-card shadow h-100">
            ...
            <div class="card-body">
                ...
                <div class="detail-item">
                    <span class="detail-label"><i class="bi bi-box me-2"></i>Items:</span>
        ...
        <div class="card admin-card shadow h-100">
            ...
            <div class="card-body">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value">{{ $order->user->orders->count() }}</span>
                </div>

                <a href="{{ route('admin.users.show', $order->user) }}" class="btn btn-info mt-3">
